...
const loadRuncardInfo = (scannedData) => {
    $.ajax({
        ...
        success: function (response) {
            ...
            $('#txtRuncardNumber').val(`${response['runcard']['production_lot']}`)
...
const getFviDetailsById = (id, status) => {
    $.ajax({
        ...
        success: function (response) {
            ...
            $('#txtShipmentDate', $('#formEditFVIDetails')).val(response['lot_no']);
    ...
    $.ajax({
        ...
        success: function (response) {
            if(response['details'] != null){
                ...
                $('#txtDeviceName').val(response['details']['part_name'])
                $('#txtDeviceCode').val(response['details']['part_code'])
                $('#txtPoQty').val(response['details']['po_quantity'])
                $('#txtMatDrawingNo').val(response['details']['drawing_no'])
                $('#txtMatDrawingRev').val(response['details']['drawing_rev'])
                dtVisualInspection.draw();
            }
            else{

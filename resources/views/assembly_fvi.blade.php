                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <input type="text" class="form-control" id="txtMatDrawingNo" readonly="">
                                    <input type="text" class="form-control" id="txtMatDrawingRev" readonly="">
                                    <div class="col-sm-3">
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <button class="btn btn-primary btn-sm" style="float: right;" id="btnAddFVI"><i class="fa fa-plus"></i> Add Delivery Update </button>
        ...
        <div class="modal-dialog modal-xl modal-xl-custom" role="document">
            <div class="modal-content">
                        ...
                        <div class="col-sm-4 border px-4">
                            <form id="formEditFVIDetails">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col pt-3">
                                        <span class="badge badge-secondary">1.</span> Delivery Update Details
                                        ...
                                        <div class="col">
                                            <div class="input-group input-group-sm mb-3">
                                                <div class="input-group-prepend w-50">
                                                    <span class="input-group-text w-100" id="basic-addon1">Order Number</span>
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="input-group input-group-sm mb-3">
                                                <div class="input-group-prepend w-50">
                                                    <span class="input-group-text w-100" id="basic-addon1">Order Qty</span>
                                                </div>
                                        ...
                                        <div class="col">
                                            <div class="input-group input-group-sm mb-3">
                                                ...
                                                <input type="text" class="form-control form-control-sm" id="txtFVILotNo"
                                                    name="txt_lot_no" placeholder="Auto generated">
                                            </div>
                                        </div>
                                    </div>
                                    {{-- <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="input-group input-group-sm mb-3">
                                                <div class="input-group-prepend w-50">
                                                    <span class="input-group-text w-100" id="basic-addon1">Shipment Date</span>
                                                </div>
                                                <input type="date" class="form-control form-control-sm" id="txtShipmentDate"
                                                    name="txt_shipment_date">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col">
                                            <div class="input-group input-group-sm mb-3">
                                                <div class="input-group-prepend w-50">
                                                    <span class="input-group-text w-100" id="basic-addon1">Material Drawing #:</span>
                                                </div>
                                                <input type="text" class="form-control form-control-sm" id="txtFVIMatDrawingNo" name="txt_mat_drawing_no" readonly>
                                                <input type="text" class="form-control form-control-sm" id="txtFVIMatDrawingRev" name="txt_mat_drawing_rev" readonly>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-sm-8">
                            <div class="row">
                                <div class="col border py-3 px-4 border-left-0 border-bottom-0">
                                    <div class="mb-3">
                                        <span class="badge badge-secondary">2.</span> Delivery Record
                                        <button class="btn btn-primary btn-sm float-right" id="btnAddFVIRuncard" disabled><i class="fa fa-plus" ></i> Add New</button>
                                    </div>
                                    <div class="table-responsive">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-success btn-sm" id="btnSubmitToLotApp">Submit</button>
            ...
            <div class="modal-content modal-lg">
                ...
                <form id="formFVIRuncard">
                    ...
                    <div class="modal-footer d-flex justify-content-between">
                        ...
                        <button type="button" class="btn btn-success" id="btnSaveFVIRuncardDetails">Save</button>
                    </div>
                </form>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#btnAddFVI').on('click', function(){
            ...
            $('#txtFVIMatDrawingNo').val($('#txtMatDrawingNo').val());
            $('#txtFVIMatDrawingRev').val($('#txtMatDrawingRev').val());
        ...
        $('#btnSaveFVIRuncardDetails').on('click', function(e){
            e.preventDefault();

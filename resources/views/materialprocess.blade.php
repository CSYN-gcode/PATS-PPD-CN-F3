                          ...
                          <div class="col-sm-12">
                              ...
                              <div class="form-group">
                                ...
                                {{-- <input type="text" class="form-control" name="process"
                                  ...
                                  <select class="form-control select2bs5" id="selAddMatProcProcess" name="process">

                                  </select>
                              </div>
                              <div class="form-group">
                                <label>Machine</label>
                                <select class="form-control select2bs5" id="selAddMatProcMachine" name="machine[]" multiple>

                                </select>
                              </div>
                              <div class="form-group">
                                <label>Station</label>
                                <select class="form-control select2bs5" id="selAddMatStation" name="">
                                </select>
                              </div>
                              <div class="form-group">
                                <label>Material Name</label>

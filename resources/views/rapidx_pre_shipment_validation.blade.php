...
@section('title', 'RapidX Pre-Shipment Validation')
			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"> <a href="{{ route('rapidx_pre_shipment') }}">Home</a> </li>
						<li class="breadcrumb-item active">RapidX Pre-Shipment Validation </li>
					</ol>
				</div>
			</div>
		</div><!-- /.container-fluid -->

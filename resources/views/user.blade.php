          ...
          <div class="modal-body">
            <div class="row">
              <div class="col-sm-12">
                ...
                <div class="form-group">
                  <label>User Level</label>
                    <select class="form-control selectUserLevel" name="user_level_id" style="width: 100%;">
                      <!-- Code generated -->
                    </select>
                </div>
                ...
                <div class="form-group">
                  <label>Position</label>
                    <select class="form-control" name="position" style="width: 100%;" id="selEditUserPosition">
                ...
                <div class="form-group">
                  <label>Section</label>
                    <select class="form-control" name="section" style="width: 100%;" id="selEditUserSection" required>
                      <option selected value="0">N/A</option>
          ...
          <div class="modal-body">
            ...
            <div class="row">
              <div class="col-sm-12">
                ...
                <div class="form-group">
                  <label>Position</label>
                    <select class="form-control" name="position" style="width: 100%;" id="selAddUserPosition">
                      <option selected value="" disabled>N/A</option>
                      <option value="0">ISS</option>
                      <option value="1">Prod'n Supervisor</option>
                      <option value="2">QC Supervisor</option>
                ...
                <div class="form-group">
                  <label>Section</label>
                    <select class="form-control" name="section" style="width: 100%;" id="selAddUserSection" required>
                      <option selected value="0">N/A</option>
                      <option value="1">Molding</option>
                      {{-- <option value="2">Molding</option> --}}
                    </select>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function () {
      ...
      dataTableUsers = $("#tblUsers").DataTable({
        ...
        //   GetUserLevel($("#selAddUserLevel", $('#formAddUser')));
        });
        ...
        //   GetUserLevel($("#selEditUserLevel", $('#formEditUser')));
